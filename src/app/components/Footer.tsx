...
export default function Footer() {
  const facebookUrl = "https://www.facebook.com/frances.camota.2025"
  const instagramUrl = "https://www.instagram.com/francescamotaa_/reels/"
  return (
    <footer className="glass text-white border-t border-violet-900/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-violet-200/80 mb-6 max-w-md">
              Professional video editing and graphic design services that help businesses 
              and creators bring their visions to life with stunning visual content.
            </p>
